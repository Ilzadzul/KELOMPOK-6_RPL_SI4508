...
use App\Http\Controllers\JadwalBimbinganKarirController;
use App\Http\Controllers\RiwayatTestController;
use App\Http\Controllers\TestUjiKemampuanDetailController;
...
Route::middleware('auth')->name('admin.')->group(function () {
    Route::resource('test-uji-kemampuan', TestUjiKemampuanController::class);
    Route::resource('test-uji-kemampuan-detail', TestUjiKemampuanDetailController::class);
    Route::get('riwayat-test', [RiwayatTestController::class, 'index'])->name('riwayat-test.index');
    Route::get('riwayat-test/{id}', [RiwayatTestController::class, 'show'])->name('riwayat-test.show');
    Route::resource('jadwal-bimbingan-karir', JadwalBimbinganKarirController::class)->except('show');
});
