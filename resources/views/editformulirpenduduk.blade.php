            ...
            <div class="card mb-3 m-lg-6 p-8 shadow-none" style="background-color: #F3FAFF;">
                ...
                <div id="card-body">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-12">
                            <textarea type="text" class="form-control @error('alamat') is-invalid @enderror"name="alamat" id="alamat" placeholder="Durian runtuh, Malaysia">{{ old('alamat', $kontak->alamat) }}</textarea>
                            @error('alamat')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
