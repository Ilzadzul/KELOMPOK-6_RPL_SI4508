        ...
        <div class="row">
            <div class="col-12">
                <div class="card border shadow-xs mb-4">
                    ...
                    {{-- <!-- Form Pencarian -->
                    <form action="{{ route('kelurahan.index') }}" method="GET" style="margin: 15px;">
                        <input type="text" name="keyword" value="{{ old('keyword', $keyword) }}" placeholder="Cari kelurahan atau nomor KTP..." class="form-control" />
                            ...
                            <table id="genderTable" class="align-items-center">
                                ...
                                <tbody>
                                    @if($kelurahans->isEmpty())
                                        <tr>
                                            <td colspan="5">No results found for '{{ $keyword }}'</td>
                                        </tr>
                                    @else
                    ...
                    <div class="card-body px-0 py-0">
                        @foreach ($pendudukGroupedByKelurahan as $kelurahanId => $penduduks)
                            @php
