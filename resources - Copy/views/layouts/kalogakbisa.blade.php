            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('riwayat*') ? 'active' : '' }}"
                        href="{{ route('admin.riwayat-test.index') }}">
                        <div
                            class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('testujikemampuan*') ? 'active' : '' }}"
                        href="{{ route('admin.test-uji-kemampuan.index') }}">
                        <div
                            class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('rekomendasipekerjaan*') ? 'active' : '' }}"
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('kategoripekerjaan*') ? 'active' : '' }}"
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('bimbingan*') ? 'active' : '' }}"
                        href="{{ route('admin.jadwal-bimbingan-karir.index') }}">
                        <div
                            class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="fas fa-graduation-cap text-danger text-sm opacity-10"></i>
                        </div>
                ...
                <li
                    class="nav-item "@auth @if (auth()->user()->user_type === 'Super Admin') '' @else style="display:none;" @endif @endauth>
                    <a class="nav-link {{ Request::is('pengaturanadmin*') ? 'active' : '' }}"
                    ...
                    <ul class="navbar-nav  justify-content-end">
                        <li class="nav-item d-flex align-items-center">
                            <a href="javascript:;" class="nav-link text-white font-weight-bold px-0">
                                ...
                                <span class="d-sm-inline d-none">{{ explode(' ', Auth::user()->fullname)[0] }}
